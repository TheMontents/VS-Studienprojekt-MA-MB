...
##### 1.2.1.2.4 Docker Image:

Um ein entsprechendes Dockerimage mit der React Anwendung zu erstellen wurde ein Dockerfile erstellt und damit ein entsprechendes Image erstellt.
